...
// Google's official multi-color "G" mark. Brand guidelines call for it to
// stay unrecolored, so this renders raw — unlike the app's other icons it's
// never tinted to match the theme.
