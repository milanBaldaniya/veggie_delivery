...
// Admin-editable legal/informational documents, shown in-app and on the
// admin frontend's public /legal/:slug page (no login required) — see
// admin/src/utils/legalDocs.js for the type<->slug mapping.
